...
static ngx_command_t  ngx_http_proxy_commands[] = {
    ...
    { ngx_string("proxy_quic_idle_timeout"),
      ...
      ngx_conf_set_msec_slot,
      NGX_HTTP_LOC_CONF_OFFSET,
      offsetof(ngx_http_proxy_loc_conf_t, upstream.quic.idle_timeout),
      NULL },
...
ngx_http_proxy_create_loc_conf(ngx_conf_t *cf)
{
    ...
    conf->upstream.quic.idle_timeout = NGX_CONF_UNSET_MSEC;
#endif
...
ngx_http_proxy_merge_loc_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    ngx_conf_merge_msec_value(conf->upstream.quic.idle_timeout,
                              prev->upstream.quic.idle_timeout, 60000);
