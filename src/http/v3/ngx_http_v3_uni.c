...
#define NGX_HTTP_V3_MAX_LITERAL  1024
...
ngx_http_v3_uni_parse_type(ngx_connection_t *c, void *data, ngx_buf_t *b)
{
    ...
    case NGX_HTTP_V3_STREAM_CONTROL:
        ...
        stc->data = c;
        stc->max_literal = NGX_HTTP_V3_MAX_LITERAL;
    ...
    case NGX_HTTP_V3_STREAM_ENCODER:
        ...
        ste->data = c;
        ste->max_literal = NGX_HTTP_V3_MAX_LITERAL;
    ...
    case NGX_HTTP_V3_STREAM_DECODER:
        ...
        std->data = c;
        std->max_literal = NGX_HTTP_V3_MAX_LITERAL;
